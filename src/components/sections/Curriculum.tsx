    ...
    <SectionWrapper theme="warm-bg" id="curriculum">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="relative">
          ...
          <div className="absolute left-5 top-0 bottom-0 w-px bg-accent/20 hidden md:block" />
            ...
            {currentSeminar.curriculum.map((step, index) => (
              ...
              >
                ...
                <div className="hidden md:flex shrink-0 w-10 items-start justify-center pt-6">
                  <div className="w-10 h-10 rounded-full bg-accent text-white flex items-center justify-center text-sm font-bold z-10 shadow-[0_0_16px_rgba(139,124,246,0.2)]">
                    {index + 1}
                  </div>
                </div>
