      ...
      >
        ...
        <div className="bg-accent/[0.06] ring-1 ring-accent/20 p-1.5 rounded-[2rem]">
          <div className="bg-white rounded-[calc(2rem-0.375rem)] p-8 md:p-12 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_2px_8px_rgba(28,25,23,0.04)] text-center">
            <h2 className="font-display text-[28px] md:text-[36px] font-bold text-[#1C1917] leading-snug mb-6 text-balance">
              다음 세미나에서 만나요
            </h2>

            <p className="text-[#57534E] text-base md:text-lg leading-relaxed max-w-xl mx-auto mb-10 break-keep">
              AI는 더 이상 선택이 아닙니다.
              <br />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-sm text-[#57534E] mb-8">
