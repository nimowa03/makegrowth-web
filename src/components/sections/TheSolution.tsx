...
const solutions = [
  ...
  },
  {
    ...
    title: "하루 만에 완성, 바로 운영",
    description:
      "세미나 당일 실제 작동하는 AI 콘텐츠 자동화 파이프라인을 가져갑니다. 이론이 아닌, 당장 내일부터 쓸 수 있는 시스템입니다.",
  },
  {
    icon: "solar:users-group-rounded-linear",
    title: "커뮤니티 기반 지속 성장",
    description:
      "세미나 이후에도 커뮤니티를 통해 최신 업데이트, 노하우 공유, 상호 피드백을 받을 수 있습니다. 혼자가 아닌, 함께 성장합니다.",
  },
];
